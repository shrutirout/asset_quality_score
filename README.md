...
├── outputs/
│   ├── baseline_results.json               # 📁 Baseline metrics for reference
│   ├── best_xgboost.pkl                    # 💾 Saved XGBoost model
│   ├── lime_explanation.html               # 💡 LIME HTML explanation for model interpretability
